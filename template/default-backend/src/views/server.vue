...
import {getServerInfo, getServerStatisticsList} from "@/api/frontend/server.js";
...
<template>
  <div class="container mt-3" v-if="server">
    <h1 class="mb-3">
      <button class="btn btn-primary" @click="goHome">返回</button>
      状态速览 - {{ server.name }}
    </h1>
    <div  class="server">
        ...
        <div class="shadow-box mb-3">
          <div class="row">
            <div class="col-md-8">
              ...
              >
                <server-statistics-bar :width="10" :height="30"
                                       :total="total"></server-statistics-bar>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="shadow-box mb-3">
              ...
              <div class="mb-3">
                <el-progress
                    :percentage="help.formatPercent(server.server_info.mem_total, server.server_state.mem_used)"
            ...
            <div class="shadow-box mb-3">
              ...
              <div class="mb-3">
                <el-progress
                    :percentage="help.formatPercent(server.server_info.disk_total, server.server_state.disk_used)"
